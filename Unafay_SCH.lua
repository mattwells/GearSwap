...
function init_gear_sets()
	...
	sets.precast.JA['Light Arts'] = {legs="Acad. Pants +3"}
  ...
  back={ name="Lugh's Cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','"Fast Cast"+10','Phys. dmg. taken-10%',}},
}
...
function job_post_precast(spell, action, spellMap, eventArgs)
    if spell.english == "Phalanx" then
        windower.send_command("send @run gs equip sets.Resting;wait 3;send @run gs c update")
    end
end
