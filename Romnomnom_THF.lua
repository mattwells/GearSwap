function get_sets()
	...
	sets.TP.HighACC = set_combine(sets.TP.MidACC,{
		head="Whirlpool Mask",
		-- body="Manibozho Jerkin", ring1="Mars's Ring",
		-- waist="Anguinus Belt"
	})
	...
	sets.TP.HighACC.MidHaste = set_combine(sets.TP.MidACC.MidHaste,{
		head="Whirlpool Mask", neck="Iqabi neckpiece",
	...
	-- PDT/MDT Sets --
	sets.PDT = {
		head="Iuitl Headgear +1", neck="Twilight Torque", ear1="Black Earring", ear2="Darkness Earring",
		body="Iuitl Vest +1", hands="Iuitl Wristbands +1", ring1="Dark Ring", ring2="Shadow Ring",
	...
	sets.WS.Evisceration = {
		head="Uk'uxkaj cap", neck="Nefarious collar", ear1="Moonshade Earring", ear2="Brutal earring",
		body="Pillager's Vest +1", hands="Pillager's armlets +1", ring1="Ramuh ring", ring2="Epona's ring",
	...
	-- 	back="Kayapa cape", waist="Wanion belt", legs="Pillager's culottes +1", feet="Plunderer's poulaines +1"
	-- }
...
function precast(spell,action)
        if spell.type == "WeaponSkill" then
                if player.status ~= 'Engaged' then -- Cancel WS If You Are Not Engaged. Can Delete It If You Don't Need It --
                        ...
                        if spell.english == "Evisceration" and player.tp > 299 then -- Equip Jupiter's Pearl When You Have 300 TP --
