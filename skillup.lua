...
function get_sets()
	...
	skillupcount = 1
	geospells = {"Indi-Poison","Indi-Voidance","Indi-Precision","Indi-Attunement"}
	geocount = 1
	...
	healingcount = 1
	enhancespells = {"Protect", "Shell"} --{"Baraera","Baraero","Barblizzara","Barblizzard","Barfira","Barfire","Barstone","Barstonra","Barthunder","Barthundra","Barwater","Barwatera"}
	enhancecount = 1
	...
	if new=='Idle' then
		...
		if skilluprun then
			...
			elseif skilluptype[skillupcount] == "Enhancing" then
				send_command('wait 1.0;input /ma "'..enhancespells[enhancecount]..'" Unafay')
...
function filtered_action(spell)
	if skilluprun then
		...
		elseif spell.skill == "Enhancing Magic" then
			...
			send_command('input /ma "'..enhancespells[enhancecount]..'" Unafay')
			return
...
function aftercast(spell)
	if skilluprun then
		if spell.interrupted then
			...
			elseif skilluptype[skillupcount] == "Enhancing" then
				send_command('wait 3.0;input /ma "'..enhancespells[enhancecount]..'" Unafay')
			elseif skilluptype[skillupcount] == "Ninjutsu" then
